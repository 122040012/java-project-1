 ...
 */
public class ComponentR extends MouseAdapter {
     ...
     */
    public ComponentR(Component... components) {
     ...
     * @param components components to be automatically registered
     */
    public ComponentR(Insets dragInsets, Component... components) {
     ...
     * @param components components to be automatically registered
     */
    public ComponentR(Insets dragInsets, Dimension snapSize, Component... components) {
