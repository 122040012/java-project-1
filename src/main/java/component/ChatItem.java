...
public class ChatItem extends javax.swing.JLayeredPane {
   ...
   public void setImage(boolean right, Icon... image) {
    ...
    public void sendSuccess() {
        if (label != null) {
            label.setIcon(new javax.swing.ImageIcon("/Users/filberthamijoyo/NetBeansProjects/mavenproject1/src/main/libraries/icons8-tick-48.png"));
        }
    }

    public void seen() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/Users/filberthamijoyo/NetBeansProjects/mavenproject1/src/main/libraries/icons8-double-tick-48.png")));
        }
    }
    ...
    private void initComponents() {
        ...
        txt.setSelectionColor(new java.awt.Color(107, 255, 119));
        add(txt);
